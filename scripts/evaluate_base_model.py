...
def main():
    parser = argparse.ArgumentParser(description="Evaluate the base Gemma model before fine-tuning.")
    parser.add_argument("--model_name", type=str, default="unsloth/gemma-3-270m-it", help="The base model to evaluate.")
